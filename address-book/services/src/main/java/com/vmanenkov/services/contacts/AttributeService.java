...
public interface AttributeService {
    Attribute create(String name, String description) throws AttributeNotValidException;

    Attribute get(Long id) throws AttributeNotFoundException;

    Attribute update(Long id, String name, String description) throws AttributeNotFoundException, AttributeNotValidException;
